...
func (in *KustoRetentionPolicy) DeepCopyInto(out *KustoRetentionPolicy) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KustoRetentionPolicy.
func (in *KustoRetentionPolicy) DeepCopy() *KustoRetentionPolicy {
	if in == nil {
		return nil
	}
	out := new(KustoRetentionPolicy)
	in.DeepCopyInto(out)
	return out
}
